...
export const API_ROUTES = {
  ...
  BOOKINGS: {
    ...
    GET: (id: string) => `/api/booking-luxury/${id}`,
    UPDATE: (id: string) => `/api/booking-luxury/${id}`,
    CANCEL: (id: string) => `/api/booking-luxury/${id}/cancel`,
    TRACK: (id: string) => `/api/booking-luxury/${id}/track`,
  },
  PRICING: {
  ...
  DRIVERS: {
    LIST: '/api/drivers',
    GET: (id: string) => `/api/drivers/${id}`,
    LOCATION: (id: string) => `/api/drivers/${id}/location`,
    AVAILABILITY: (id: string) => `/api/drivers/${id}/availability`,
  },
  ADMIN: {
