...
/**
 * Simple Test Runner for Multiple Drops Route System
 * مشغل الاختبارات البسيط لنظام الطرق متعددة التوصيل
 */
...
function displayHelp() {
  ...
  log(`
Usage: node test-multiple-drops-simple.js [options]
...
Examples:
  node test-multiple-drops-simple.js                    # Run all tests
  node test-multiple-drops-simple.js --test-type smoke  # Run smoke test only
  node test-multiple-drops-simple.js --test-type load   # Run load test only
  node test-multiple-drops-simple.js --help            # Show this help
