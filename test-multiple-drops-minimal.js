...
/**
 * Minimal Test Runner for Multiple Drops Route System
 * مشغل الاختبارات الأدنى لنظام الطرق متعددة التوصيل
 */
...
function displayHelp() {
  ...
  log(`
Usage: node test-multiple-drops-minimal.js [options]
...
Examples:
  node test-multiple-drops-minimal.js                    # Run all tests
  node test-multiple-drops-minimal.js --test-type smoke  # Run smoke test only
  node test-multiple-drops-minimal.js --test-type load   # Run load test only
  node test-multiple-drops-minimal.js --help            # Show this help
