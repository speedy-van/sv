...
/**
 * Fast Test Runner for Multiple Drops Route System
...
function displayHelp() {
  ...
  log(`
Usage: node test-multiple-drops-fast.js [options]
...
Examples:
  node test-multiple-drops-fast.js                    # Run all tests
  node test-multiple-drops-fast.js --test-type smoke  # Run smoke test only
  node test-multiple-drops-fast.js --test-type load   # Run load test only
  node test-multiple-drops-fast.js --help            # Show this help
