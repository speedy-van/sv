      ...
      // Security headers for all routes (HSTS, CSP, etc.)
      {
        ...
        headers: [
          ...
          // Content Security Policy - Best Practices
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://js.stripe.com https://www.googletagmanager.com https://www.google-analytics.com https://static.cloudflareinsights.com https://*.pusher.com https://widget.trustpilot.com https://*.trustpilot.com https://api.mapbox.com https://*.mapbox.com",
              ...
              "worker-src 'self' blob: https://api.mapbox.com https://*.mapbox.com",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
