...
function checkSecretStrength(secret: string, minLength: number = 32): { valid: boolean; strength: string } {
...
// Check URL security
function checkUrlSecurity(url: string): { valid: boolean; issues: string[] } {
  const issues: string[] = [];
