...
export const REVIEW_RESPONSE_TEMPLATES = {
  ...
  negative: [
    {
      template: `We sincerely apologize for your experience with our {service_type} service. This doesn't meet our standards. Please contact us directly at support@speedy-van.co.uk or call 01202 129746 so we can make this right.`,
    ...
    {
      template: `We're very sorry to hear about your experience in {location}. This is not the level of service we strive for. Please contact our customer service team at support@speedy-van.co.uk or 01202 129746 so we can address your concerns immediately.`,
