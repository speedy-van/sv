...
export const metadata = {
  title: 'Man and Van Kesgrave | 24/7 Removals & Delivery | Speedy Van',
  description: 'Professional man and van service in Kesgrave. 24/7 availability, fully insured, competitive rates. Book your Kesgrave removal or delivery today!',
};

export default function ManAndVanKesgravePage() {
  return (
    <Box>
      {/* Hero Section */}
        ...
        <Container maxW="container.xl">
          <Stack spacing={6} textAlign="center">
            <Heading as="h1" size="2xl">
              Man and Van Kesgrave
            </Heading>
            <Text fontSize="xl" color="gray.600">
              Professional removal and delivery service in Kesgrave. Available 24/7 with competitive rates.
            </Text>
        ...
        <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} spacing={8}>
          <VStack>
            ...
            <Text textAlign="center" color="gray.600">
              Round-the-clock service in Kesgrave
            </Text>
          </VStack>
          <VStack>
      ...
      <Box bg="gray.50" py={16}>
        <Container maxW="container.xl">
          <Heading textAlign="center" mb={12}>
            Our Services in Kesgrave
          </Heading>
          <SimpleGrid columns={{ base: 1, md: 3 }} spacing={8}>
            <Box bg="white" p={6} borderRadius="lg" shadow="md">
              <Heading size="md" mb={4}>House Removals</Heading>
              <Text color="gray.600">
                Full house moving service with professional packing and loading in Kesgrave.
              </Text>
            </Box>
            <Box bg="white" p={6} borderRadius="lg" shadow="md">
              <Heading size="md" mb={4}>Office Moves</Heading>
              <Text color="gray.600">
                Efficient office relocation with minimal downtime for Kesgrave businesses.
              </Text>
            </Box>
            <Box bg="white" p={6} borderRadius="lg" shadow="md">
              <Heading size="md" mb={4}>Furniture Delivery</Heading>
              <Text color="gray.600">
                Safe delivery of furniture and large items across Kesgrave.
              </Text>
            </Box>
          </SimpleGrid>
        </Container>
      ...
      <Container maxW="container.xl" py={16}>
        <Heading textAlign="center" mb={12}>
          Transparent Pricing for Kesgrave
        </Heading>
        <SimpleGrid columns={{ base: 1, md: 3 }} spacing={8}>
          <Box borderWidth={1} borderRadius="lg" p={6} textAlign="center">
            ...
            <Text color="gray.600">Perfect for small moves and deliveries in Kesgrave</Text>
          </Box>
          <Box borderWidth={1} borderRadius="lg" p={6} textAlign="center" borderColor="brand.500" borderWidth={2}>
            ...
            <Text color="gray.600">Ideal for 1-2 bedroom moves in Kesgrave</Text>
          </Box>
          <Box borderWidth={1} borderRadius="lg" p={6} textAlign="center">
            <Heading size="lg" mb={2}>£45/hr</Heading>
            <Text fontWeight="bold" mb={4}>Luton Van</Text>
            <Text color="gray.600">Best for large moves and office relocations in Kesgrave</Text>
          </Box>
        </SimpleGrid>
      </Container>
      ...
      <Box bg="brand.500" color="white" py={16}>
        <Container maxW="container.xl" textAlign="center">
          <Heading mb={4}>Ready to Book Your Kesgrave Move?</Heading>
          <Text fontSize="lg" mb={8}>
            Get an instant quote or call us now for same-day service in Kesgrave
          </Text>
          <Stack direction={{ base: 'column', md: 'row' }} spacing={4} justify="center">
            <Link href="/quote">
