...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return new NextResponse(
      generateHTML('error', 'Server Error', 'An error occurred while verifying your email. Please contact support at support@speedy-van.co.uk or call 01202129746'),
      {
        headers: { 'Content-Type': 'text/html' },
      }
    );
      ...
      <div class="container">
        ...
        <div class="footer">
          ...
          <div class="contact">
            ...
            📞 <a href="tel:01202129746">01202129746</a>
          </div>
        </div>
      </div>
    </body>
