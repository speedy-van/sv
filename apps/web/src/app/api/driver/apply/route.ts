...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      const smsMessage = `Hi ${application.firstName}, your Speedy Van driver application has been received! We'll review it within 24-48 hours and notify you of the status. Application ID: ${application.id}. Call 01202 129746 for support.`;
