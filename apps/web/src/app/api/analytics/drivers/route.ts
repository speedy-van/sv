 ...
 * 
 * Get driver performance analytics for a given time period
 * Query parameters:
 * - startDate: ISO date string
 * - endDate: ISO date string
 * - limit: number of drivers to return (default: 50, max: 100)
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const drivers = await AnalyticsService.getDriverAnalytics(startDate, endDate, limit);
