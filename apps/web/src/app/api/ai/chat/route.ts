...
const RAG_FAQ_SEED: RAGFaq[] = [
  { id: 'faq_insurance', question: 'Are items insured?', answer: 'Yes, all moves are covered by comprehensive goods-in-transit insurance. For questions, email support@speedy-van.co.uk or call 01202 129746.', tags: ['insurance', 'safety'] },
    ...
    if (!groq) {
      ...
      return NextResponse.json(
        { 
          ...
          message: 'I apologize, but the AI service is currently unavailable. Please contact support at support@speedy-van.co.uk or call 01202 129746 for assistance.',
        },
        { status: 503 }
      );
    }
