...
export const metadata = {
  title: 'Man and Van Chipping Norton | 24/7 Removals & Delivery | Speedy Van',
  description: 'Professional man and van service in Chipping Norton. 24/7 availability, fully insured, competitive rates. Book your Chipping Norton removal or delivery today!',
};

export default function ManAndVanChippingNortonPage() {
  return (
    <Box>
      {/* Hero Section */}
        ...
        <Container maxW="container.xl">
          <Stack spacing={6} textAlign="center">
            <Heading as="h1" size="2xl">
              Man and Van Chipping Norton
            </Heading>
            <Text fontSize="xl" color="gray.600">
              Professional removal and delivery service in Chipping Norton. Available 24/7 with competitive rates.
            </Text>
        ...
        <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} spacing={8}>
          <VStack>
            ...
            <Text textAlign="center" color="gray.600">
              Round-the-clock service in Chipping Norton
            </Text>
          </VStack>
          <VStack>
      ...
      <Box bg="gray.50" py={16}>
        <Container maxW="container.xl">
          <Heading textAlign="center" mb={12}>
            Our Services in Chipping Norton
          </Heading>
          <SimpleGrid columns={{ base: 1, md: 3 }} spacing={8}>
            <Box bg="white" p={6} borderRadius="lg" shadow="md">
              <Heading size="md" mb={4}>House Removals</Heading>
              <Text color="gray.600">
                Full house moving service with professional packing and loading in Chipping Norton.
              </Text>
            </Box>
            <Box bg="white" p={6} borderRadius="lg" shadow="md">
              <Heading size="md" mb={4}>Office Moves</Heading>
              <Text color="gray.600">
                Efficient office relocation with minimal downtime for Chipping Norton businesses.
              </Text>
            </Box>
            <Box bg="white" p={6} borderRadius="lg" shadow="md">
              <Heading size="md" mb={4}>Furniture Delivery</Heading>
              <Text color="gray.600">
                Safe delivery of furniture and large items across Chipping Norton.
              </Text>
            </Box>
          </SimpleGrid>
        </Container>
      ...
      <Container maxW="container.xl" py={16}>
        <Heading textAlign="center" mb={12}>
          Transparent Pricing for Chipping Norton
        </Heading>
        <SimpleGrid columns={{ base: 1, md: 3 }} spacing={8}>
          <Box borderWidth={1} borderRadius="lg" p={6} textAlign="center">
            ...
            <Text color="gray.600">Perfect for small moves and deliveries in Chipping Norton</Text>
          </Box>
          <Box borderWidth={1} borderRadius="lg" p={6} textAlign="center" borderColor="brand.500" borderWidth={2}>
            ...
            <Text color="gray.600">Ideal for 1-2 bedroom moves in Chipping Norton</Text>
          </Box>
          <Box borderWidth={1} borderRadius="lg" p={6} textAlign="center">
            <Heading size="lg" mb={2}>£45/hr</Heading>
            <Text fontWeight="bold" mb={4}>Luton Van</Text>
            <Text color="gray.600">Best for large moves and office relocations in Chipping Norton</Text>
          </Box>
        </SimpleGrid>
      </Container>
      ...
      <Box bg="brand.500" color="white" py={16}>
        <Container maxW="container.xl" textAlign="center">
          <Heading mb={4}>Ready to Book Your Chipping Norton Move?</Heading>
          <Text fontSize="lg" mb={8}>
            Get an instant quote or call us now for same-day service in Chipping Norton
          </Text>
          <Stack direction={{ base: 'column', md: 'row' }} spacing={4} justify="center">
            <Link href="/quote">
