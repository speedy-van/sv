...
export const metadata: Metadata = {
  title: 'Man and Van Dundee | 24/7 Removals & Delivery | Speedy Van',
  description: 'Professional man and van service in Dundee. 24/7 online booking, instant quotes, fully insured. From £25/hour. Call 01202 129746 for same-day service.',
  keywords: 'man and van dundee, removals dundee, van hire dundee, delivery service dundee, house removals dundee',
  openGraph: {
    title: 'Man and Van Dundee | 24/7 Removals & Delivery',
    description: 'Professional man and van service in Dundee. Instant quotes, fully insured, from £25/hour.',
    type: 'website',
  },
}

export default function ManAndVanDundeePage() {
  return (
    <Box>
      {/* Hero Section */}
