...
export const metadata: Metadata = {
  title: 'Man and Van Portsmouth | 24/7 Removals & Delivery | Speedy Van',
  description: 'Professional man and van service in Portsmouth. 24/7 online booking, instant quotes, fully insured. From £25/hour. Call 01202 129746 for same-day service.',
  keywords: 'man and van portsmouth, removals portsmouth, van hire portsmouth, delivery service portsmouth, house removals portsmouth',
  openGraph: {
    title: 'Man and Van Portsmouth | 24/7 Removals & Delivery',
    description: 'Professional man and van service in Portsmouth. Instant quotes, fully insured, from £25/hour.',
    type: 'website',
  },
}

export default function ManAndVanPortsmouthPage() {
  return (
    <Box>
      {/* Hero Section */}
        ...
        <Container maxW="container.xl">
          <VStack spacing={6} align="start">
            <Heading as="h1" size="2xl" fontWeight="bold">
              Man and Van Portsmouth
            </Heading>
            <Text fontSize="xl" maxW="2xl">
              Professional removal and delivery service in Portsmouth. Available 24/7 with instant online booking.
      ...
      <Box py={16} bg="gray.50">
        <Container maxW="container.xl">
          <Heading as="h2" size="xl" mb={8} textAlign="center">
            Why Choose Our Portsmouth Man and Van Service?
          </Heading>
        ...
        <Container maxW="container.xl">
          ...
          <SimpleGrid columns={{ base: 1, md: 2 }} spacing={8}>
            <Box p={6} borderWidth={1} borderRadius="lg">
              ...
              <Text color="gray.600">
                Full house or flat removals in Portsmouth. From single items to entire properties.
            ...
            <Box p={6} borderWidth={1} borderRadius="lg">
              ...
              <Text color="gray.600">
                ...
                to keep your Portsmouth business running.
              </Text>
            </Box>
            <Box p={6} borderWidth={1} borderRadius="lg">
              <Heading as="h3" size="md" mb={3}>Furniture Delivery</Heading>
              <Text color="gray.600">
                Collect and deliver furniture anywhere in Portsmouth. Same-day service available
            ...
            <Box p={6} borderWidth={1} borderRadius="lg">
              ...
              <Text color="gray.600">
                Affordable student removal service in Portsmouth. Perfect for university accommodation
      ...
      <Box py={16} bg="gray.50">
        <Container maxW="container.xl">
          <Heading as="h2" size="xl" mb={8} textAlign="center">
            Transparent Pricing in Portsmouth
          </Heading>
      ...
      <Box py={16}>
        <Container maxW="container.xl">
          ...
          <Text fontSize="lg" color="gray.600" mb={6}>
            Our man and van service covers all areas of Portsmouth and surrounding regions.
            Whether you're in the city centre or suburbs, we provide fast, reliable service
            with no hidden charges.
          </Text>
          <Text fontSize="lg" color="gray.600" mb={8}>
            We also offer competitive rates for moves between Portsmouth and other UK cities.
        ...
        <Container maxW="container.xl">
          <VStack spacing={6}>
            <Heading as="h2" size="xl" textAlign="center">
              Ready to Book Your Portsmouth Man and Van?
            </Heading>
