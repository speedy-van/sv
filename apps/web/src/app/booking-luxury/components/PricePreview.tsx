...
export default function PricePreview({
  ...
  useEffect(() => {
    ...
    // Calculate estimated duration (30 mph average + 30 min loading/unloading)
    const drivingMinutes = Math.round((distanceInMiles / 30) * 60);
    const totalMinutes = drivingMinutes + 30;
        ...
        <VStack spacing={4} align="stretch">
          ...
          <HStack justify="space-between" align="center">
            <HStack spacing={3}>
              ...
              >
                <Icon as={FaPoundSign} color="blue.400" boxSize={5} />
              </Box>
              <VStack spacing={0} align="flex-start">
                ...
                <Text color="whiteAlpha.600" fontSize="xs" fontWeight="500">
          ...
          {showPreview ? (
            <VStack spacing={3} align="stretch">
              ...
              <VStack spacing={2} align="stretch">
                ...
                >
                  <HStack spacing={2}>
                    <Icon as={FaRoute} color="blue.300" boxSize={4} />
                    <Text color="whiteAlpha.800" fontSize="sm" fontWeight="500">
                      Distance
                    </Text>
                  </HStack>
                  <Text color="white" fontSize="sm" fontWeight="600">
                    {distance?.toFixed(1)} km ({(distance! * 0.621371).toFixed(1)} miles)
                  </Text>
                </HStack>
                ...
                {estimatedDuration && (
                  ...
                  >
                    <HStack spacing={2}>
                      <Icon as={FaClock} color="purple.300" boxSize={4} />
                      <Text color="whiteAlpha.800" fontSize="sm" fontWeight="500">
                        Est. Duration
                      </Text>
                    </HStack>
                ...
                >
                  <HStack spacing={2} align="flex-start">
                    <Icon as={FaInfoCircle} color="blue.300" boxSize={3} mt={0.5} />
                    <Text color="whiteAlpha.700" fontSize="xs" lineHeight="tall">
