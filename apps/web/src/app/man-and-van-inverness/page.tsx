...
export const metadata: Metadata = {
  title: 'Man and Van Inverness | 24/7 Removals & Delivery | Speedy Van',
  description: 'Professional man and van service in Inverness. 24/7 online booking, instant quotes, fully insured. From £25/hour. Call 01202 129746 for same-day service.',
  keywords: 'man and van inverness, removals inverness, van hire inverness, delivery service inverness, house removals inverness',
  openGraph: {
    title: 'Man and Van Inverness | 24/7 Removals & Delivery',
    description: 'Professional man and van service in Inverness. Instant quotes, fully insured, from £25/hour.',
    type: 'website',
  },
}

export default function ManAndVanInvernessPage() {
  return (
    <Box>
      {/* Hero Section */}
        ...
        <Container maxW="container.xl">
          <VStack spacing={6} align="start">
            ...
            <Text fontSize="xl" maxW="2xl">
              Professional removal and delivery service in Inverness. Available 24/7 with instant online booking.
      ...
      <Box py={16} bg="gray.50">
        <Container maxW="container.xl">
          <Heading as="h2" size="xl" mb={8} textAlign="center">
            Why Choose Our Inverness Man and Van Service?
          </Heading>
        ...
        <Container maxW="container.xl">
          ...
          <SimpleGrid columns={{ base: 1, md: 2 }} spacing={8}>
            <Box p={6} borderWidth={1} borderRadius="lg">
              ...
              <Text color="gray.600">
                Full house or flat removals in Inverness. From single items to entire properties.
            ...
            <Box p={6} borderWidth={1} borderRadius="lg">
              ...
              <Text color="gray.600">
                ...
                to keep your Inverness business running.
              </Text>
            </Box>
            <Box p={6} borderWidth={1} borderRadius="lg">
              <Heading as="h3" size="md" mb={3}>Furniture Delivery</Heading>
              <Text color="gray.600">
                Collect and deliver furniture anywhere in Inverness. Same-day service available
            ...
            <Box p={6} borderWidth={1} borderRadius="lg">
              ...
              <Text color="gray.600">
                Affordable student removal service in Inverness. Perfect for university accommodation
      ...
      <Box py={16} bg="gray.50">
        <Container maxW="container.xl">
          <Heading as="h2" size="xl" mb={8} textAlign="center">
            Transparent Pricing in Inverness
          </Heading>
      ...
      <Box py={16}>
        <Container maxW="container.xl">
          <Heading as="h2" size="xl" mb={6}>
            Serving All of Inverness
          </Heading>
          <Text fontSize="lg" color="gray.600" mb={6}>
            Our man and van service covers all areas of Inverness and surrounding regions.
            Whether you're in the city centre or suburbs, we provide fast, reliable service
            with no hidden charges.
          </Text>
          <Text fontSize="lg" color="gray.600" mb={8}>
            We also offer competitive rates for moves between Inverness and other UK cities.
        ...
        <Container maxW="container.xl">
          <VStack spacing={6}>
            <Heading as="h2" size="xl" textAlign="center">
              Ready to Book Your Inverness Man and Van?
            </Heading>
