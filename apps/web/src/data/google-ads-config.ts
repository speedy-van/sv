...
export const AD_COPY_TEMPLATES = [
  {
    ...
    description1: 'Professional moving services in {City}. Fast quotes, online booking, and 24/7 support. Fully insured drivers.',
  ...
  },
  {
    ...
    description2: 'Same-day service subject to availability. Fully insured. Get your free quote online now.',
    path1: 'removals',
    path2: '{city}',
  },
  {
